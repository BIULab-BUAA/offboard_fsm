 ...
 * @LastEditTime: 2022-09-21 16:41:10
...
#include <offboard_sample/input.h>
...
private:
    ...
    bool trigger_, flag_simulation_, start_mission_, flag_emergency_stop_, has_quad_cmd_, has_odom_;
    ...
    ros::Subscriber state_sub_, odom_sub_, imu_sub_, extent_state_sub_, local_position_sub_, local_velocity_sub_, joy_sub_, quad_cmd_sub_;
    ...
    std::pair<int, TrajFSMAtt::FSM_EXEC_STATE > timesOfConsecutiveStateCalls();
...
public:
	TrajFSMAtt(Parameter_t &param,LinearControl &contorller);
